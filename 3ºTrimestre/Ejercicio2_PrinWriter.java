...
public class Ejercicio2_PrinWriter {
    ...
    public static void escribeFichero(String salida) {
        ...
        try {
            f_sal = new FileWriter(salida);
            p_sal = new PrintWriter(f_sal);
            p_sal.println("Este texto es un ejemplo de escritura en el fichero de salida");
        } catch (IOException e) {
