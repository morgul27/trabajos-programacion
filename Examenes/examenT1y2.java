...
public class examenT1y2 {
	public static void main(String args[]) {
		...
		String[][] Preguntas = {
				...
				{ "En que año se celebró el mundial de futbol en España", "Nunca se ha celebrado un mundial en España",
						"2010", "1982", "c" },
				...
				{ "Cual es el único jugador que ha marcado al menos un gol e cinco mundiales consecutivos", "Messi",
						"Cristiano Ronaldo", "Borja Iglesias", "b" },
				{ "Contra que selección ha sido la mayor goleada a favor de España en un mundial",
						"6-1 a Bulgaria en Francia 1998", "7-0 a Costa Rica en Catar 2022",
						"12-1 a Malta en España 1982", "b" }
		};
